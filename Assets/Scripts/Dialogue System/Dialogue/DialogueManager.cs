...
public class DialogueManager : MonoBehaviour
{
    ...
    void Start()
    {
        //En un inicio, el Dialogo estara desactivado
    ...
    void Update()
    {
        ...
        //Caso contrario, si se est� reproduciendo di�logo...
    ...
    private void DisplayChoices()
    {
        ...
        {
            Debug.LogError("La historia presenta m�s opciones de las esperadas. Se recibieron: " + currentDialogueChoices.Count);
        }
    ...
    private void HandleTags(List<string> currentTags)
    {
        ...
        foreach (string tag in currentTags)
        {
            ...
            switch (tagKey)
            {
                ...
                case PORTRAIT_TAG:
                    //  Reproducimos la Animacion correspondiente
                    portraitAnimator.Play(tagValue);
                    break;

                case LAYOUT_TAG:
                    //Reproducimos la Animacion para ordenar el Layout
                    layoutAnimatour.Play(tagValue);
                    break;
    ...
    {
        //Si ya podemos cambiar de linea (acab� de escribirse)...
    ...
    private void PlayDialogueSound(int currentDisplayedCharacterCount)
    {
        ...
        if (currentDisplayedCharacterCount % soundFrecuencyLevel == 0)
        {
            ...
            //Modificamos el Pitch de forma aleatoria <-- Ligera variaci�n
